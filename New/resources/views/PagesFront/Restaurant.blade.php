...
<head>
	...
	<script>
		window.jQuery || document.write('<script src="js1/vendor/jquery-1.10.2.min.js"><\/script>')
	</script>
...
<body>
	...
	<section id="hero-area">
		<img class="img-responsive" src="images1/header.jpg" alt="">
	</section>
	<!--
    Header start 
	============================== -->
				...
				<div class="col-md-12">
					<div class="block wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
						...
						<div id="owl-example" class="owl-carousel">
							<div>
								<img class="img-responsive" src="images1/slider/slider-img-1.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="images1/slider/slider-img-2.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="images1/slider/slider-img-3.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="images1/slider/slider-img-4.jpg" alt="">
							</div>
							<div>
								<img class="img-responsive" src="images1/slider/slider-img-1.jpg" alt="">
							</div>
	...
	<section id="about-us">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="block">
						<img class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms" src="images1/cooker-img.png"
							alt="cooker-img">
					...
					<div class="block">
						...
						<ul>
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="300ms">
								<div class="blog-img">
									<img src="images1/blog/blog-img-1.jpg" alt="blog-img">
								</div>
							...
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="400ms">
								<div class="blog-img">
									<img src="images1/blog/blog-img-2.jpg" alt="blog-img">
								</div>
								<div class="content-right">
									<h3>Homestyle Chicken Pot Pie</h3>
									<p>Prepared in true New England fash-ion. Tender all-white meat chicken simmered...
							...
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="500ms">
								...
								<div class="blog-img-2">
									<img src="images1/blog/blog-img-3.jpg" alt="blog-img">
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="600ms">
								...
								<div class="blog-img-2">
									<img src="images1/blog/blog-img-4.jpg" alt="blog-img">
								</div>
							</li>
							<li class="wow fadeInLeft" data-wow-duration="300ms" data-wow-delay="700ms">
								<div class="blog-img">
									<img src="images1/blog/blog-img-5.jpg" alt="blog-img">
								</div>
								<div class="content-right">
									<h3>Homestyle Chicken Pot Pie</h3>
									<p>Prepared in true New England fash-ion. Tender all-white meat chicken simmered...
							...
							<li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="800ms">
								<div class="blog-img">
									<img src="images1/blog/blog-img-6.jpg" alt="blog-img">
								</div>
								<div class="content-right">
									<h3>Homestyle Chicken Pot Pie</h3>
									<p>Prepared in true New England fash-ion. Tender all-white meat chicken simmered...
	...
	<section id="price">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="block">
						<h1 class="heading wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">Nos
							<span>Plats</span> Les <span>Prix</span></h1>
						<p class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">Lorem ipsum dolor sit
							amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
							magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco </p>
						<div class="pricing-list">
							<div class="title">
								<h3>Prochainement  <span>dans le weekend</span></h3>
							</div>
							<ul>
								<li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
									<div class="item">
										<div class="item-title">
											<h2>Sauce d'Arrachide avec Riz Blanc et viande de cochon</h2>
											<div class="border-bottom"></div>
											<span>2500fcfa</span>
                                            
										</div>
                                        <button class="btn-sm">Commander</button>
										<p>Un repas savoureux.Bonne Appetit à vous</p>
									</div>
								</li>
								<li class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="400ms">
									<div class="item">
										<div class="item-title">
											<h2>Pate noir avec sauce légume bien assaisonner</h2>
											<div class="border-bottom"></div>
											<span>3500 fcfa</span>
				...
				<div class="col-md-4">
					<div class="block wow fadeInLeft" data-wow-delay="1100ms">
						<div class="gallary">
							...
							<ul>
								<li>
									<a href="#"><img src="images1/photo/photo-1.jpg" alt=""></a>
								</li>
								<li>
									<a href="#"><img src="images1/photo/photo-2.jpg" alt=""></a>
								</li>
								<li>
									<a href="#"><img src="images1/photo/photo-3.jpg" alt=""></a>
								</li>
								<li>
									<a href="#"><img src="images1/photo/photo-4.jpg" alt=""></a>
								</li>
							</ul>
						</div>
